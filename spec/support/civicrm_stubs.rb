...
module CivicrmStubs
  ...
  def stub_user_valid_request
    stub_successful_request_for(user_request_url, file_fixture("user_valid_response.txt"))
  end

  def stub_user_not_found_request
    stub_successful_request_for(user_request_url, file_fixture("user_not_found_response.txt"))
  end

  def stub_user_invalid_request
    stub_successful_request_for(user_request_url, file_fixture("user_invalid_response.txt"))
  end

  ## Contact
  def stub_contact_valid_request
    stub_successful_request_for(contact_request_url, file_fixture("contact_valid_response.txt"))
  end

  ## Groups
  def stub_groups_valid_request
    stub_successful_request_for(groups_request_url, file_fixture("groups_valid_response.txt"))
  end
  
  ## Users in group
  def stub_users_in_group_valid_request
    stub_successful_request_for(users_in_group_request_url, file_fixture("users_in_group_valid_response.txt"))
  end
