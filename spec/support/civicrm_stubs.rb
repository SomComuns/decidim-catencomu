...
module CivicrmStubs
  ...
  def users_in_group_request_url
    "https://api.base/?action=Get&api_key=api-key&entity=Contact&json=%7B%22sequential%22:1,%22options%22:%7B%22limit%22:0%7D,%22group%22:%22Administrators%22,%22return%22:%22id,display_name,group%22,%22api.Usercat.get%22:%7B%22return%22:%22id%22%7D%7D&key=secret"
  end
